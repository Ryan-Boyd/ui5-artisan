(function() {
    ...
    exports.scaffold = scaffold = function(options) {
        ...
        if (!fs.statSync(process.cwd() +"/"+ projectName).isDirectory()){

            fs.mkdirSync(process.cwd() +"/"+ projectName);
            fs.mkdirSync(process.cwd() +"/"+ projectName + "/webapp");
            fs.mkdirSync(process.cwd() +"/"+ projectName + "/webapp/i18n");
    ...
    exports.controller = controller = function(options) {
        ...
        var controllerName = "PlainController.js";
    ...
    exports.viewController = viewController = function(options) {
