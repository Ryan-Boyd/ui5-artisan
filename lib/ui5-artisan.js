(function() {
    ...
    exports.scaffold = scaffold = function(options) {
        ...
        readWrite(basedir + "package.json", __dirname + "/stubs/bootstrap/package.json", "package.json", nameSpace, viewNS);
        ...
        readWrite(wrtdir + "controller/BaseController.js", __dirname + "/stubs/bootstrap/BaseController.js", "BaseController.js", nameSpace, controllerNS);
    }
